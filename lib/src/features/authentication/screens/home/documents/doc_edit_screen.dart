...
class DocItemEditScreen extends StatefulWidget {
  const DocItemEditScreen({super.key, required DocumentsModel model});

  @override
  State<DocItemEditScreen> createState() => _DocItemEditScreenState();
}

class _DocItemEditScreenState extends State<DocItemEditScreen> {
